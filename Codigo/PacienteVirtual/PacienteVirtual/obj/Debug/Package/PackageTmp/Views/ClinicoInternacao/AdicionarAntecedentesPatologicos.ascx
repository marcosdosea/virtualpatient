<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<PacienteVirtual.Models.AntecedentesPatologicosModel>" %>
<%@ Import Namespace = "PacienteVirtual.Helpers" %>

<% using (Html.BeginForm("AdicionarAntecedentesPatologicos", "ClinicoInternacao"))
   { %>
