...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: Resources.Mensagem.definir_administrador_enfermagem %>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

<h2><%: Resources.Mensagem.definir_administrador_enfermagem %></h2>
...
<%= Html.Grid(Model).Columns(columns =>
    {
        ...
        columns.Add()
                ...
                .Sanitized(false)
                .SetWidth(30)
                .RenderValueAs(o => Html.ActionLink(Resources.Mensagem.ativar, "DefinirAdmEnfermagem", new { idPessoa = o.IdPessoa }, new { @class = "modal-link" }));
        ...
        columns.Add()
                ...
                .Sanitized(false)
                .SetWidth(30)
                .RenderValueAs(o => Html.ActionLink(Resources.Mensagem.desativar, "RemoverAdmEnfermagem", new { idPessoa = o.IdPessoa }, new { @class = "modal-link" }));
