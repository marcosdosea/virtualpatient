...
CREATE DATABASE IF NOT EXISTS pv1;
USE pv1;
...
INSERT INTO `aluno` (`login`,`anoInicioCurso`,`flCursouAssistenciaFarmaceutica`,`flCursouAtencaoFarmaceutica`,`flCursouDispencaoFarmaceutica`,`flCursouFarmaciaClinica`,`flCursouIntroducaoFarmacia`,`flCursouSemiologiaFarmaceutica`,`flCursouTopicosFarmaciaClinica`,`genero`,`idade`,`matricula`,`fkTurma`,`nome`,`liberado`,`fkConsultaAtual`,`nrConsulta`,`nrTentativa`,`flAcessoCasa`,`flAcessoCasaAmigo`,`flAcessoOutro`,`flAcessoUniversidade`) VALUES 
 (' Nelson',2006,'T','T','F','F','T','F','F','M',27,'06123691',1,'Nelson Rubens Moreira','S',NULL,1,1,'F','F','F','V'),
 ('aline',2006,'T','T','F','T','T','F','T','F',23,'06121845',1,'Aline de Oliveira Lima','S',NULL,1,1,'V','F','F','V'),
 ('araujo_bes',2006,'T','T','F','T','T','F','F','M',23,'06122854',1,'Bruno Eduardo Silva de Araújo','S',NULL,1,1,'V','F','F','V'),
 ('bernardo',2006,'F','T','T','F','T','T','T','M',23,'1010',1,'Bernardo','S',16,1,1,'V','F','F','V'),
 ('cledison',2006,'T','F','F','F','T','F','T','M',24,'06120967',1,'cledison santos ramos','S',NULL,1,1,'V','F','F','F'),
 ('Daniela Araujo',2006,'T','T','F','F','T','F','F','F',22,'06120051',1,'Daniela Araujo Melo','S',12,3,1,'V','V','F','V'),
 ('ericafabianne',2006,'T','T','F','T','T','F','F','F',22,'06120401',1,'Érica Fabianne Oliveira Souza','S',NULL,1,1,'V','F','F','F'),
 ('Gi',2005,'T','T','T','T','T','T','T','F',24,'05122062',1,'Giselle Brito','S',NULL,1,1,'V','F','F','F'),
 ('Joana Luiza ',2006,'T','T','F','T','F','F','F','F',22,'06120815',1,'Joana Luiza Costa Almeida','S',NULL,1,1,'V','F','F','V'),
 ('johnny.farma',2006,'T','T','F','T','T','F','T','M',28,'06123271',1,'João Luiz Alves dos Santos','S',NULL,1,1,'V','F','F','F'),
 ('Juliana',2006,'T','T','F','T','T','F','T','F',23,'06120030',1,'Juliana Almeida Ferreira','S',10,3,1,'V','F','F','V'),
 ('Júnior',2006,'T','T','F','T','T','F','F','M',22,'06121819',1,'Genival Araújo dos Santos Júnior','S',NULL,1,1,'V','F','F','F'),
 ('laiane vasconcelos',2006,'T','T','T','T','T','F','F','F',23,'06121851',1,'laiane tiara santos vasconcelos','S',NULL,1,1,'V','F','F','F'),
 ('Laís Sena',2006,'T','T','T','T','T','F','F','F',21,'06123224',1,'Laís Cristina Santana Sena','S',13,3,1,'V','F','F','V'),
 ('Larissa Carvalho',2006,'T','T','F','T','T','F','T','F',23,'06121138',1,'Larissa Feitosa Carvalho','S',9,3,1,'V','F','V','V'),
 ('maksonoliveira',2006,'T','T','F','T','T','F','F','M',24,'06123549',1,'MAKSON GLEYDSON BRITO DE OLIVEIRA','S',11,3,1,'V','F','F','F'),
 ('Marcos',2005,'T','T','F','T','T','F','F','M',23,'07120746',1,'Marcos Daniel Seabra Santos','S',14,3,1,'V','F','F','F'),
 ('Nayanna Lessa',2006,'T','T','F','T','T','F','T','F',22,'06121079',1,'Nayanna Mendes Neves Lessa','S',NULL,1,1,'V','V','F','V'),
 ('Renata',2006,'T','T','F','T','T','F','F','F',23,'06122173',1,'Renata Souza de Carvalho','S',NULL,1,1,'V','V','F','F'),
 ('tamireslima',2006,'T','T','T','T','T','F','F','F',22,'06121997',1,'Tamires Cardoso Lima','S',NULL,1,1,'V','F','F','V'),
 ('testeabc',2003,'F','F','F','F','T','F','F','F',0,'01234567',1,'Testando','S',6,2,2,'V','V','V','V'),
 ('Thais Teles',2006,'T','T','F','T','T','F','T','F',23,'06122718',1,'Thaís Teles de Souza','S',NULL,1,1,'V','F','F','V'),
 ('Vinícius',2006,'T','T','F','F','T','F','F','M',23,'06122304',NULL,'Carlos Vinícius Costa da Conceição','S',NULL,1,1,'V','V','F','V'),
 ('vivianne',2005,'T','T','F','T','T','F','F','F',23,'05122351',1,'Vivianne Freire Santos','S',NULL,1,1,'V','F','F','F');
...
INSERT INTO `intervencao` (`id`,`descricao`,`numeroEtapa`,`numeroIntervencao`,`fkCasoClinico`) VALUES 
 (8,'Orientação sobre modificação do estilo de vida',1,9,3),
 (9,'Orientação prática sobre o uso do medicamento prescrito',2,3,3),
 (10,'Orientação sobre modificação do estilo de vida',2,9,3),
 (11,'Orientação para procurar outro profissional de saúde',2,10,3),
 (16,'Orientação sobre modificação do estilo de vida',1,9,5),
 (17,'Outras orientações necessárias',1,11,5),
 (18,'Orientação prática sobre o uso do medicamento prescrito',2,3,5),
 (19,'Orientação sobre a doença',2,7,5),
 (20,'Orientação sobre modificação do estilo de vida',2,9,5),
 (21,'Orientação sobre as dúvidas relativas à administração do medicamento',1,2,6),
 (22,'Orientação prática sobre o uso do medicamento prescrito',1,3,6),
 (23,'Orientação sobre o armazenamento dos medicamentos',1,6,6),
 (24,'Orientação sobre educação sanitária',1,8,6),
 (25,'Orientação sobre modificação do estilo de vida',1,9,6),
 (26,'Orientação para procurar outro profissional de saúde',1,10,6),
 (27,'Outras orientações necessárias',1,11,6),
 (28,'Orientação sobre a indicação de um novo medicamento prescrito',2,1,6),
 (29,'Orientação prática sobre o uso do medicamento prescrito',2,3,6),
 (30,'Orientação sobre modificação do estilo de vida',2,9,6),
 (31,'Orientação para procurar outro profissional de saúde',2,10,6),
 (32,'Outras orientações necessárias',2,11,6),
 (33,'Orientação prática sobre o uso do medicamento prescrito',1,3,7),
 (34,'Orientação sobre o armazenamento dos medicamentos',1,6,7),
 (35,'Orientação sobre a doença',1,7,7),
 (36,'Orientação sobre educação sanitária',1,8,7),
 (37,'Orientação sobre modificação do estilo de vida',1,9,7),
 (38,'Orientação para procurar outro profissional de saúde',1,10,7),
 (39,'Outras orientações necessárias',1,11,7),
 (40,'Orientação prática sobre o uso do medicamento prescrito',2,3,7),
 (41,'Orientação sobre modificação do estilo de vida',2,9,7),
 (42,'Orientação para procurar outro profissional de saúde',2,10,7),
 (43,'Outras orientações necessárias',2,11,7),
 (44,'Orientação prática sobre o uso do medicamento prescrito',1,3,8),
 (45,'Orientação sobre a doença',1,7,8),
 (46,'Orientação sobre educação sanitária',1,8,8),
 (47,'Orientação sobre modificação do estilo de vida',1,9,8),
 (48,'Outras orientações necessárias',1,11,8),
 (49,'Orientação sobre a indicação de um novo medicamento prescrito',2,1,8),
 (50,'Orientação sobre a doença',2,7,8),
 (51,'Orientação prática sobre o uso do medicamento prescrito',1,3,9),
 (52,'Orientação sobre o armazenamento dos medicamentos',1,6,9),
 (53,'Orientação sobre a doença',1,7,9),
 (54,'Orientação sobre educação sanitária',1,8,9),
 (55,'Orientação sobre modificação do estilo de vida',1,9,9),
 (56,'Orientação para procurar outro profissional de saúde',1,10,9),
 (57,'Outras orientações necessárias',1,11,9),
 (58,'Orientação prática sobre o uso do medicamento prescrito',2,3,9),
 (59,'Orientação sobre a doença',2,7,9),
 (60,'Orientação sobre modificação do estilo de vida',2,9,9),
 (61,'Orientação para procurar outro profissional de saúde',2,10,9),
 (62,'Outras orientações necessárias',2,11,9);
...
INSERT INTO `intervencaorespostasegunda` (`id`,`descricao`,`justificativa`,`numeroIntervencao`,`fkResposta2`) VALUES 
 (14,'Orientação sobre as dúvidas relativas à administração do medicamento','Questionar como o paciente toma seus medicamentos e orientá-lo sobre a administração correta dos medicamentos',2,8),
 (15,'Orientação prática sobre o uso do medicamento prescrito','Esclarecer melhor o uso da associação de Losartano+Atenolol+Anlodipino+Hidroclorotiazida, visto que o paciente toma metade da posologia prescrita',3,8),
 (20,'Orientação sobre possíveis interações, causada por um medicamento','Tacrolimus interage com omeprazol.',4,10),
 (21,'Orientação sobre RAM real ou potencial, causada por um medicamento','vários medicamentos causam RAM e precisam ser corrijidos.',5,10),
 (22,'Orientação sobre o armazenamento dos medicamentos','armazenar em locais seguros e arejados, nunca na cozinha e banheiro.',6,10),
 (23,'Orientação sobre a doença','informar de forma didatica como a doença é causada e importância do tratamento correto.',7,10),
 (81,'Orientação sobre as dúvidas relativas à administração do medicamento','NA PRÓXIMA CONSULTA O PACIENTE SERÁ QUESTIONADO QUANTO A EXIST&#7868;NCIA DE DÚVIDAS SOBRE A ADMINISTRAÇÃO DOS MEDICAMENTOS.',2,31),
 (82,'Orientação prática sobre o uso do medicamento prescrito','MOSTRAR A IMPORTÂNCIA DE O PACIENTE ADERIR AO TRATAMENTO E ALERTAR SOBRE OS RISCOS DA AUTOMEDICAÇÃO.TAMBÉM PODE SER ELABORADA UMA TABELA DE HORÁRIO DE TOMADA DOS MEDICAMENTOS, VISTO QUE O PACIENTE ESQUECE DE TOMAR ALGUNS MEDICAMENTOS NO HORÁRIO CORRETO.',3,31),
 (83,'Orientação sobre RAM real ou potencial, causada por um medicamento','O CELECOXIB E O AAS PODEM AGRAVAR A QUEIMAÇÃO RELATADA PELO PACIENTE. É IMPORTANTE PERGUNTAR AO PACIENTE SE ESSA CONDIÇÃO É ALTERADA APÓS O USO DESSES MEDICAMENTOS.',5,31),
 (84,'Orientação sobre o armazenamento dos medicamentos','oRIENTAR AO PACIENTE PARA NÃO GUARDAR OS MEDICAMENTOS NA COZINHA OU NO BANHEIRO OU EM LOCAIS ÚMIDOS OU SOB A INCIDÊNCIA DE LUZ.',6,31),
 (85,'Orientação sobre a doença','FALAR DA IMPORTÂNCIA DE CUMPRIR O TRATAMENTO DA HIPERTENSÃO ARTERIAL, POIS ALÉM DE ESTA SER UMA DOENÇA CRÔNICA, NA MAIORIA DAS VEZES A MESMA SE MOSTRA ASSINTOMÁTICA.',7,31),
 (86,'Orientação sobre modificação do estilo de vida','o PACIENTE POSSUI UM ESTILO DE VIDA ADEQUADO AS SUAS DOENÇAS (O MESMO POSSUI UMA DOENÇA RESTRITIVA DE SAL E GORDURA E PRATICA EXERCÍCIOS FÍSICOS)',9,31),
 (87,'Orientação sobre a indicação de um novo medicamento prescrito','Investigar a quanto tempo o paciente vem sentindo dores e com base nisso suspeitar de PRM.',1,32),
 (88,'Orientação sobre as dúvidas relativas à administração do medicamento','Explicar ao paciente sobre o uso do colírio e saber como ele administra os seus medicamentos',2,32),
 (89,'Orientação prática sobre o uso do medicamento prescrito','Utilização da tabela de horário para a correta tomada dos medicamentos; Uso de folder ilustrativo com orientações sobre administração e armazenamento dos medicamentos prescritos',3,32),
 (90,'Orientação sobre possíveis interações, causada por um medicamento','Falar dos riscos da auto-medicação, assim como os riscos de tomar medicamentos com chás',4,32),
 (91,'Orientação sobre o armazenamento dos medicamentos','Instruir para guardar os medicamentos em locais de pouca luminosidade e umidade, em temperatura ambiente (com exceção do colírio que deve ser guardado na geladeira antes de ser aberto), fora do alcance de crianças e em local visível',6,32),
 (92,'Orientação sobre a doença','explicar sobre os riscos das doenças presentes, esclarecer suas dúvidas e a importância do cumprimento do tratamento',7,32),
 (93,'Orientação para procurar outro profissional de saúde','indicar uma consulta a um oftalmologista para controle do glaucoma e uma consulta a um clínico geral para avaliar as dores',10,32),
 (94,'Orientação sobre a indicação de um novo medicamento prescrito','lsdkasjv fasf',1,33),
 (95,'Orientação sobre as dúvidas relativas à administração do medicamento','fadsf safas',2,33),
 (96,'Orientação prática sobre o uso do medicamento prescrito','faskjh kfshak jfh kjahskjfhaskjfhaskh fkjashfkjashkfajshkfhsak h sakh  kas ',3,33),
 (97,'Orientação sobre possíveis interações, causada por um medicamento','1',4,33),
 (98,'Orientação sobre RAM real ou potencial, causada por um medicamento','1',5,33),
 (99,'Orientação sobre o armazenamento dos medicamentos','1',6,33),
 (100,'Orientação sobre a doença','1',7,33),
 (101,'Orientação sobre educação sanitária','1',8,33),
 (102,'Orientação sobre modificação do estilo de vida','1',9,33),
 (103,'Orientação para procurar outro profissional de saúde','1',10,33),
 (104,'Outras orientações necessárias','1',11,33),
 (105,'Orientação sobre a indicação de um novo medicamento prescrito','sdf dfsfscs',1,34),
 (106,'Orientação prática sobre o uso do medicamento prescrito','jkdfhj sdjkfhskj\r\ndfs\r\nfsdfd \r\nfdsf',3,34),
 (107,'Orientação sobre o armazenamento dos medicamentos','fdsf',6,34),
 (108,'Orientação sobre educação sanitária','dsf',8,34),
 (109,'Orientação para procurar outro profissional de saúde','fdsfds',10,34),
 (110,'Orientação sobre possíveis interações, causada por um medicamento','Conversar com o cardiologista sobre a possibilidade de troca da associação de Losartano+Atenolol+Anlodipino+Hidroclorotiazida por outro medicamento, visto que atenolol aumenta os efeitos hiperglicemiantes dos tiazidicos e a hidroclorotiazida diminui os efeitos da metformina. Sendo importante ressaltar a alergia relatada pelo paciente ao propanolol e ao captopril',4,8),
 (111,'Orientação sobre RAM real ou potencial, causada por um medicamento','Conversar com o cardiologista sobre a possibilidade de troca da associação de Losartano+Atenolol+Anlodipino+Hidroclorotiazida por outro medicamento, visto que o anlodipino possivelmente está causando impotência sexual, diminuição da libido, fraqueza e perda da memória que o paciente relata sentir; e o atenolol possivelmente também está relacionado com a impotência sexual que o paciente relata sentir. Sendo importante ressaltar a alergia relatada pelo paciente ao propanolol e ao captopril',5,8),
 (112,'Orientação sobre o armazenamento dos medicamentos','Os medicamentos devem der armazenados de preferência em locais secos e arejados, evitando armazenar na cozinha e banheiro, e deixando fora do alcance de crianças.',6,8),
 (113,'Orientação sobre a doença','Orientar através de video aulas e folders sobre as causas, consequencias das doenças relatadas e possibilidades de tratamento das mesmas',7,8),
 (114,'Orientação sobre educação sanitária','Informações educativas através de video aulas e folders mostrando a importancia dos cuidados com a saúde masculina',8,8),
 (115,'Orientação sobre modificação do estilo de vida','Informações educativas através de video aulas e folders sobre a importancia de ter habitos de vida saudáveis, ressaltando a importancia da realização de atividades fisicas regulares; o controle adequado da dieta; e as consequências do consumo excessivo de álcool.',9,8),
 (116,'Orientação para procurar outro profissional de saúde','Se possivel, o paciente deve procurar orientação de um educador fisico e de um nutricionista.',10,8),
 (117,'Orientação sobre as dúvidas relativas à administração do medicamento','Instruções sobre a correta administração da Insulina, bem como seu armazenamento sob refrigeração.',2,30),
 (118,'Orientação prática sobre o uso do medicamento prescrito','Orientar sobre administração do uso da Diltiazem 60mg antes das refeições. Utilizar metformina durantes as refeições. Administrar o AAS junto com pequenas refeições. Explicar a importância do cumprimento da prescrição da insulina, mesmo não estando em casa.',3,30),
 (119,'Orientação sobre RAM real ou potencial, causada por um medicamento','Orientar reavaliação pelo neurologista sobre a utilização da Oxcarbazepina 300mg',5,30),
 (120,'Orientação sobre o armazenamento dos medicamentos','Orientação sobre acondicionamento da insulina sob refrigeração. Orientar armazenamento correto dos demais medicamentos.',6,30),
 (121,'Orientação sobre a doença','Orientações sobre doenças pode ajudar no manejo da doença pela paciente. Contribui para melhorar o cumprimento da terapia medicamentosa e não-medicamentosa. ',7,30),
 (122,'Orientação sobre modificação do estilo de vida','Estimular participação em grupos sociais, como, igreja, trabalhos solidários. Paciente mostrou interesse em continuar estudos, logo, incentivar a paciente.',9,30),
 (123,'Orientação para procurar outro profissional de saúde','Procurar profissional capacitado para controle da artrose, tendinite e dor nas costas.',10,30),
 (124,'Outras orientações necessárias','Questionar sobre o consumo de álcool. Questionar sobre a restrição de carboidratos. Conscientizar sobre o  consumo de chá.',11,30),
 (125,'Orientação para procurar outro profissional de saúde','ORIENTAR O PACIENTE A PROCURAR UM GASTROENTEROLOGISTA PARA VERIFICAR O FATO DE A QUEIMAÇÃO NÃO TER MELHORADO E SEU PROBLEMA DE REFLUXO (FRISAR QUE O PACIENTE NÃO FEZ USO DO MEDICAMENTO PRESCRITO, O PANTOPRAZOL. O MESMO SE AUTOMEDICOU COM RANITIDINA).ACONSELHAR O MESMO A PROCURAR UM CARDIOLOGISTA PARA VER SE TEM COMO SUBSTITUIR O ANLODIPINO POR OUTRO MEDICAMENTO, POIS O PACIENTE ALEGA NÃO CUMPRIR A TERAPIA DEVIDO AO MEDICAMENTO SER MUITO CARO.SUGERIR QUE O PACIENTE PROCURE UM ESPECIALISTA EM VIRTUDE DAS SUAS DORES MUSCULARES, POIS O PACIENTE ESTÁ FAZENDO USO DE CELECOXIB, O QUAL FOI PRESCRITO PELO ONCOLOGISTA.SUGERIR AO CARDIOLOGISTA E RETIRADA DO CIPROFIBRATO, POIS O MESMO É DESNECESSÁRIO E PODE ESTAR AGRAVANDO AS DORES MUSCULARES DO PACIENTE(O MESMO PODE SER O CAUSADOR DA ELEVAÇÃO DA ENZIMA CREATINOFOSFOQUINASE ). OBSERVAÇÃO: DAR PRIORIDADE AO PROBLEMA DE REFLUXO DO PACIENTE, POIS O MESMO JÁ FOI PARA URGÊNCIA TRÊS VEZES (NÃO TEM COMO SABER SE O REFLUXO ESTÁ SENDO AGRAVADO POR ALGUM MEDICAMENTO EM VIRTUDE DA AUSÊNCIA DE DATAS).',10,31),
 (126,'Outras orientações necessárias','FAZ SE NECESSÁRIO SABER O TEMPO DE USO DE CADA MEDICAMENTO, HÁ QUANTO TEMPO O PACIENTE SENTE AS QUEIXAS RELATADAS. VERIFICAR POR QUANTO TEMPO É NECESSÁRIO USAR CADA MEDICAMENTO (A MAIORIA DOS MEDICAMENTOS NÃO TEM TEMPO DE USO). TAMBÉM É NECESSÁRIO SABER SE O PACIENTE REALMENTE TEM ANEMIA,POIS O MESMO ESTÁ SE AUTOMEDICANDO COM UM POLIVITAMÍNICO. CONFIRMAR SE DOR, EDEMA, ALTERAÇÕES VISUAIS, DIMINUIÇÃO DA AUDIÇÃO, RINITE ALERGICA, FALTA DE AR, QUEIMAÇÃO, DOR NAS COSTAS, ANEMIA, PARESTESIA, PERDA DE EQUILÍBRIO, DEPRESSÃO, ANSIEDADE, PERDA DE MEMORIA E PARESTESIA SÃO DOENÇAS/AGRAVO OU PRMs, PARA CONFIRMAR A ORDEM DAS PRIORIDADES. ',11,31);
...
INSERT INTO `medicamentonaoprescrito` (`id`,`descricao`,`dosagem`,`posologia`,`fkCasoClinico`,`flItalico`) VALUES 
 (2,'Polivitamínico (sulfato ferroso, vitamina C, vitamina B12, ácido fólico, vitamina B1, vitamina B2, vitamina B6, nicotinamida, pantotenato de cálcio, concentrado gastro-hepático)','400mg/100mg/15mcg/0,5mg/30mg/5mg/10mg/25mg/15mg/(1:50)100mg','1 comprimido após o almoço para fraqueza',3,'F'),
 (4,'Ranitidina','150 mg','1 comprimido em jejum e 1 comprimido a noite',5,'F'),
 (5,'Polivitamínico (sulfato ferroso, vitamina C, vitamina B12, ácido fólico, vitamina B1, vitamina B2, vitamina B6, nicotinamida, pantotenato de cálcio, concentrado gastro-hepático)','400mg/100mg/15mcg/0,5mg/30mg/5mg/10mg/25mg/15mg/(1:50)100mg','1 comprimido após o almoço',5,'F'),
 (6,'Polivitamínico e mineral','variada','1 comprimido ao dia',9,'F');
...
INSERT INTO `medicamentoprescrito` (`id`,`descricao`,`dosagem`,`especialidadeMedico`,`nmMedico`,`posologia`,`fkCasoClinico`,`flItalico`) VALUES 
 (3,'Metformina','850 mg','Cardiologista','I.S.T.','1 comprimido depois do almoço',3,'F'),
 (4,'Losartano, Atenolol, Anlodipino, Hidroclorotiazida','50/50/5/12,5 mg','Cardiologista','I.S.T.','1 comprimido de 12/12h, porém o paciente relata tomar somente 1 comprimido antes do almoço',3,'F'),
 (5,'Atorvastatina','20 mg ','Cardiologista','I.S.T.','1 comprimido 12h',3,'F'),
 (9,'Pantoprazol','40 mg','Gastroenterologista','S.B.','1 comprimido em jejum e 1 a noite (durante 3 meses), porém não comprou o medicamento, achou muito caro',5,'F'),
 (10,'Sinvastatina/Ezetimiba ','20/10 mg','Cardiologista','M.R.','1 comprimido depois do jantar',5,'F'),
 (11,'Ciprofibrato','100 mg','Cardiologista','M.R.','1 comprimido ao dia',5,'F'),
 (12,'Anlodipino','5 mg','Cardiologista','M.R. ','1 comprimido de 12/12h',5,'F'),
 (13,'Celecoxib','200 mg','Oncologista','A.C.','1 comprimido ao dia, após o almoço',5,'F'),
 (14,'Ácido acetilsalicílico','100 mg','Cardiologista','M.R.','1 comprimido após o almoço',5,'F'),
 (15,'Enalapril','10 mg','Cardiologista','A.L.V.','1 comprimido de 12/12h',6,'F'),
 (16,'Atenolol','25 mg','Cardiologista','A.L.V.','1 comprimido às 12h',6,'F'),
 (17,'Latanoprost','50 mcg','Oftalmologista','não lembra','1 gota em cada olho ao deitar',6,'F'),
 (18,'Omeprazol','20 mg','Cardiologista','A.L.V.','1 comprimido em jejum',6,'F'),
 (19,'Ácido acetilsalicílico ','100 mg','Cardiologista','J.B.R.','1 comprimido depois do almoço, desde 12/2008',7,'F'),
 (20,'Atenolol','50 mg','Cardiologista','J.B.R','1 comprimido no café e 1 no jantar, desde 12/2008',7,'F'),
 (21,'Diltiazem','60 mg','Cardiologista','J.B.R.','1 comprimido 3 vezes ao dia, mas usa duas vezes ao dia nas refeições',7,'F'),
 (22,'Domperidona','10 mg','Endocrinologista','V.C.','1 comprimido 30 minutos antes das refeições (duas vezes ao dia)',7,'F'),
 (23,'Mononitrato de Isossorbida ','20 mg','Cardiologista','J.B.R.','1 comprimido depois das refeições (3 vezes ao dia)',7,'F'),
 (24,'Sinvastatina','40 mg','Cardiologista','J.B.R.','1 comprimido no jantar',7,'F'),
 (25,'Oxcarbazepina','300 mg','Neurologista','R.C.','1 comprimido depois do café e 1 depois do jantar, desde 02/2009',7,'F'),
 (26,'Vildagliptina/Metformina ','50/850 mg','Endocrinologista','V.C.','1 comprimido de cada 30 minutos antes do café e 30 minutos antes do jantar, desde 10/2008',7,'F'),
 (27,'Fluoxetina ','20 mg','Endocrinologista','V.C.','1 comprimido às 10h',7,'F'),
 (28,'Insulina Humana Regular ','12/6/6 U','Endocrinologista','V.C.','12 U antes do café/ 6 U antes do almoço/ 6 U antes do jantar',7,'F'),
 (29,'Insulina NPH ','30/18/24 U','Endocrinologista','V.C.','30 U antes do café/ 18 U antes do almoço/ 24 U antes do jantar',7,'F'),
 (30,'Hidroclorotiazida/Amilorida ','25/2,5 mg','Cardiologista','F.P.','1 comprimido em dias alternados, porém refere tomar some a hidroclorotiazida (por conta própria)',8,'F'),
 (31,'Captopril','25 mg','Cardiologista','F.P.','1 comprimido 3 vezes ao dia, usa apenas 10 e 17h, desde 12/2008',8,'F'),
 (32,'Furosemida','40 mg','Cardiologista','F.P.','1 comprimido às 9h, não usa, está prescrito desde 12/2008',8,'F'),
 (33,'Ácido acetilsalicílico ','100 mg','Cardiologista','F.P.','1 comprimido depois do almoço',8,'F'),
 (34,'Ranitidina','150 mg','Clínico Geral','J.M.','1 comprimido em jejum, desde 12/2008',8,'F'),
 (35,'Sinvastatina','20 mg','Cardiologista','F.P.','1 comprimido antes de dormir, desde 11/2008',8,'F'),
 (36,'Glibenclamida','5 mg','Geriatra','W.','1 comprimido duas vezes ao dia, só usa 1 comprimido antes do café',8,'F'),
 (37,'Metformina','850 mg','Geriatra','W.','1 comprimido duas vezes ao dia, 1 comprimido após o café e 1 após o almoço (parte o comprimido para engolir)',8,'F'),
 (38,'Nimesulida/Acetaminofeno/Ciclobenzaprina','manipulado','não delcarado','não delcarado','1 comprimido após o café e 1 após o jantar, desde 11/2006',8,'F'),
 (39,'Metformina','850 mg','Endocrinologista','M.L.','1 comprimido depois do almoço, desde 11/2008',9,'F'),
 (40,'Omeprazol','20 mg','Endocrinologista','M.L.','1 comprimido ao dia, porém só usa quando sente dor',9,'F'),
 (41,'Valsartano/Anlodipino ','160/5 mg','Cardiologista','J.L.L.B.','1 comprimido após o café da manhã',9,'F'),
 (42,'Insulina NPH','30 U em jejum e 20 U às 17h','Endocrinologista','M.L.','desde 04/2008',9,'F'),
 (43,'Cafeína/Carisoprodol/Diclofenaco sódico/Paracetamol ','30/125/50/300 mg','Ortopedista','A.L.','1 comprimido de 8/8h, usa apenas após o café da manhã e após o jantar, para a hérnia de disco, desde 12/2008',9,'F'),
 (44,'Sulfacetamida sódica','3% loção ?oil free?','Dermatologista','L.S.B.','nas manchas brancas na pele a noite durante 2 meses, desde 01/2009',9,'F'),
 (45,'Tacrolimus','0,1% creme','Dermatologista','L.S.B.','nas manchas brancas a noite durante 2 meses, desde 01/2009',9,'F');
...
INSERT INTO `medicamentoqueixa` (`id`,`descricao`,`dose`,`efetivo`,`necessario`,`periodo`,`seguro`,`cumprimento`,`fkQueixa`,`conheceCumpre`) VALUES 
 (7,'Losartano/Atenolol/Anlodipino/Hidroclorotiazida','50/50/5/12,5 mg','V','V','2 anos','V','F',14,'V'),
 (9,'Ciprofibrato','100 mg','V','F','6 meses','V','V',36,'V'),
 (10,'Anlodipino','5 mg','V','V','2 anos','F','V',37,'V'),
 (11,'Ciprofibrato','100 mg','V','V','6 meses','V','F',52,'V'),
 (12,'Sinvastatina/Ezetimiba','20/10 mg','V','V','2 anos e 2 semanas','V','F',52,'V'),
 (13,'Atenolol','25 mg','F','V','5 anos','V','V',67,'V'),
 (14,'Enalapril','10 mg','V','V','1 ano','F','V',69,'V'),
 (15,'Atorvastatina','20 mg','V','V','','V','F',81,'F'),
 (16,'Sinvastatina','40 mg','F','V','','V','V',97,'V'),
 (17,'Diltiazem','60 mg','V','V','','V','F',98,'V'),
 (18,'Insulina NPH','30/18/24 U','F','V','','V','V',101,'V'),
 (19,'Insulina Humana Regular','12/6/6 U','F','V','','V','V',101,'V'),
 (20,'Nexium','40 mg','F','V','','V','V',117,'V'),
 (21,'Amilorida','2,5 mg','V','V','','V','F',132,'V'),
 (22,'Furosemida','40 mg','V','V','2 meses','V','F',132,'V'),
 (23,'Glibenclamida','5 mg','F','V','','V','V',133,'V'),
 (24,'Valsartano/Anlodipino','160/5 mg','F','V','','V','V',163,'V'),
 (25,'Polivitaminico e mineral','variada','V','V','','F','V',163,'V'),
 (26,'Insulina NPH ','30/20 U','F','V','04/2008','V','V',165,'V'),
 (27,'Cafeína/Carisoprodol/Diclofenaco sódico/Paracetamol ','30/125/50/300 mg','F','V','12/2008','V','V',170,'V'),
 (28,'Insulina','30/ 20 U','F','V','04/2008','V','V',179,'V');
...
INSERT INTO `medicamentoqueixasegunda` (`id`,`descricao`,`dose`,`efetivo`,`necessario`,`periodo`,`seguro`,`cumprimento`,`fkQueixaSegunda`,`conheceCumpre`) VALUES 
 (18,'Losartano+Atenolol+Anlodipino+Hidroclorotiazida','50/50/5/12,5mg','','','não relatado','F','',36,'V'),
 (19,'Losartano+Atenolol+Anlodipino+Hidroclorotiazida','50/50/5/12,5mg','','','não relatado','F','',37,'V'),
 (20,'Losartano+Atenolol+Anlodipino+Hidroclorotiazida','50/50/5/12,5mg','','','não relatado','F','',38,'V'),
 (22,'1 comp. após café da manhã','160/5mg','','V','','F','V',54,'V'),
 (23,'1 comp. após café da manhã','160/5mg','','V','','F','V',55,'V'),
 (24,'1 comp. após café da manhã','160/5mg','','V','','','V',56,'V'),
 (25,'1 comp. após café da manhã','160/5mg','','V','','','V',56,'V'),
 (26,'1 comp. após café da manhã','160/5mg','','V','','','V',56,'V'),
 (27,'1 comp. depois do almoço','850mg','','V','11/2008','','V',57,'V'),
 (28,' comp. após café da manhã','160/5mg','','V','','','',59,'V'),
 (29,'1 comp. após café da manhã','160/5mg','','V','','','',60,'V'),
 (30,'1 comp. de oito em oito horas','50mg','V','V','12/2008','F','F',61,'F'),
 (31,'usa o creme nas manchas brancas durante a noite','','','V','01/2009','F','V',66,'V'),
 (32,'usa o creme nas manchas brancas durante a noite','','','V','01/2009','F','V',66,'V'),
 (33,'Hidroclorotiazida','25 mg','F','F','','V','F',87,'V'),
 (34,'Nimesulida','','F','F','11/2006','V','F',93,'V'),
 (35,'AAS','100 mg ','F','V',' 11/2008','F','F',93,'V'),
 (36,'AAS','100 mg','F','V','11/2008','F','F',96,'F'),
 (37,'Sinvastatina','20 mg','F','F','11/2008','V','F',97,'V'),
 (38,'sinvastatina','20 mg','F','F','11/2008','V','F',99,'V'),
 (39,'Hidroclorotiazida','25 mg','F','F','','V','F',100,'V'),
 (155,'Oxcarbazepina','300mg','','F','02/2009','','',391,'V'),
 (156,'Oxcarbazepina','300mg','','F','02/2009','','',393,'V'),
 (157,'Oxcarbazepina','300mg','','F','02/2009','','',394,'V'),
 (158,'Atenolol','50mg','V','V','12/2008','F','',395,'V'),
 (159,'Diltiazem','60mg','F','V','','','',396,'V'),
 (160,'Domperidona','10mg','F','V','','','',399,'V'),
 (161,'Domperidona','10mg','F','V','','','',400,'V'),
 (162,'Insulina humana e NPH','24 (U/dia) e 72 (U/dia)','V','V','','V','F',401,'V'),
 (163,'Fluoxetina','20mg','F','V','','','',407,'V'),
 (164,'Fluoxetina','20mg','F','V','','','',408,'V'),
 (165,'CIPROFIBRATO','100 mg','','F','','','',414,'V'),
 (166,'ANLODIPINO','5 mg','','','2007','','F',415,'F'),
 (167,'','s','F','','dsa','','',440,'F'),
 (168,'sd','asd','','V','sa','','',442,'');
...
INSERT INTO `parametroclinico` (`id`,`descricao`,`unidade`,`valor`,`valorDeReferencia`,`fkCasoClinico`) VALUES 
 (3,'Glicose de jejum','mg/dL',109,'60-100',3),
 (4,'Colesterol Total','mg/dL',178,'< 200',3),
 (5,'Colesterol HDL','mg/dL',45,'Diabético: > 45',3),
 (6,'Colesterol LDL','mg/dL',102,'< 100',3),
 (7,'Triglicerides','mg/dL',153,'<150',3),
 (13,'Colesterol Total ','mg/dL',166,'< 200',5),
 (14,'Colesterol HDL ','mg/dL',62,'< 40 Baixo - > 60 Alto',5),
 (15,'Colesterol LDL ','mg/dL',90,'< 100',5),
 (16,'Triglicerides','mg/dL',67,'< 150',5),
 (17,'Creatino fosfoquinase - CPK','U/L',420,'26-189',5),
 (18,'Glicemia capilar','mg/dL',109,'60-100',5),
 (19,'Colesterol Total','mg/dL',208,'< 200 ',6),
 (20,'Colesterol LDL','mg/dL',148,'< 100',6),
 (21,'Colesterol HDL','mg/dL',33,'< 40 Baixo - > 60 Alto',6),
 (22,'Glicose de jejum','md/dL',119,'60-100',6),
 (23,'Triglicerides','mg/dL',136,'< 150',6),
 (24,'HbA1c','%',13,'4,3 - 5,7',7),
 (25,'Colesterol total ','mg/dL',133,'< 200',7),
 (26,'Colesterol HDL','mg/dL',34,'Diabético > 45',7),
 (27,'Glicose de jejum','mg/dL',274,'60-100',7),
 (28,'Colesterol LD','mg/dL',71,'< 100',7),
 (29,'Uréia','mg/dL',31,'10-40',7),
 (30,'Glicose de jejum','mg/dL',84,'60-100',8),
 (31,'HbA1c','%',10.2,'4,3 ? 5,7',8),
 (32,'Sódio','mg/dL',144,'135-144 ',8),
 (33,'Colesterol HDL ','mg/dL',36,'Diabéticos > 45',8),
 (34,'Colesterol LDL  ','mg/dL',86,'< 100',8),
 (35,'Colesterol total ','mg/dL',133,'< 200',8),
 (36,'Triglicerides','mg/dL',54,'< 150',8),
 (37,'Uréia','mg/dL',30,'15-40',8),
 (38,'Creatinina','mg/dL',0.9,'0,4 ? 1,4 ',8),
 (39,'Ácido Úrico ','mg/dL',2.4,'1,5-6',8),
 (40,'Glicose de jejum','mg/dL',98,'60-100',9),
 (41,'Glicose pós-prandial','md/dL',264,'60-180',9),
 (42,'Colesterol Total','mg/dL',233,'< 200',9),
 (43,'Triglicerides','mg/dL',123,'< 150 ',9);
...
INSERT INTO `queixa` (`id`,`descricao`,`numeroEtapa`,`numeroPRM`,`fkCasoClinico`,`conheceOuPreocupa`,`periodoSurgimento`,`prioridade`) VALUES 
 (7,'Hiperlipidemia',1,-1,3,'V','',2),
 (8,'Hipertensão',1,-1,3,'V','35 anos',1),
 (9,'Diabetes',1,-1,3,'V','2008',3),
 (10,'Impotência',1,-1,3,'V','',4),
 (11,'Diminuição do desejo sexual',1,-1,3,'V','',5),
 (12,'Perda de memória',1,-1,3,'V','',6),
 (13,'Hiperlipidemia',2,-1,3,'V','',2),
 (14,'Hipertensão',2,7,3,'V','35 ano',1),
 (15,'Diabetes',2,-1,3,'V','2008',3),
 (16,'Impotência',2,-1,3,'V','',4),
 (17,'Diminuição do desejo sexual',2,-1,3,'V','',5),
 (18,'Perda de memória',2,-1,3,'V','',6),
 (31,'Dor',1,-1,5,'V','',3),
 (32,'Edema',1,-1,5,'V','',2),
 (33,'Alterações visuais',1,-1,5,'V','',7),
 (34,'Diminuição da audição',1,-1,5,'V','',8),
 (35,'Rinite alergica',1,-1,5,'V','',9),
 (36,'Hiperlipidemia',1,1,5,'V','',4),
 (37,'Hipertensão',1,5,5,'V','2 anos',1),
 (38,'Falta de ar',1,-1,5,'V','',10),
 (39,'Queimacao',1,2,5,'V','',2),
 (40,'Anemia',1,-1,5,'V','',11),
 (41,'Dor nas costas',1,-1,5,'V','',5),
 (42,'Parestesia',1,-1,5,'V','',6),
 (43,'Perda de equilíbrio',1,-1,5,'V','',12),
 (44,'Depressão',1,-1,5,'V','',13),
 (45,'Ansiedade',1,-1,5,'V','',14),
 (46,'Perda de memória',1,-1,5,'V','',15),
 (47,'Dor',2,-1,5,'V','',3),
 (48,'Edema',2,-1,5,'V','',2),
 (49,'Alterações visuais',2,1,5,'V','',7),
 (50,'Diminuição da audição',2,-1,5,'V','',8),
 (51,'Rinite alergica',2,-1,5,'V','',9),
 (52,'Hiperlipidemia',2,7,5,'V','',4),
 (53,'Hipertensão',2,-1,5,'V','2 anos',1),
 (54,'Falta de ar',2,-1,5,'V','',10),
 (55,'Queimacao',2,2,5,'V','',2),
 (56,'Anemia',2,-1,5,'V','',11),
 (57,'Dor nas costas',2,-1,5,'V','',5),
 (58,'Parestesia',2,-1,5,'V','',6),
 (59,'Perda de equilíbrio',2,-1,5,'V','',12),
 (60,'Depressão',2,-1,5,'V','',13),
 (61,'Ansiedade',2,-1,5,'V','',14),
 (62,'Perda de memória',2,-1,5,'V','',15),
 (63,'Dor',1,-1,6,'V','',1),
 (64,'Alterações visuais',1,-1,6,'V','',14),
 (65,'Glaucoma',1,-1,6,'V','',4),
 (66,'Hiperlipidemia',1,-1,6,'V','',3),
 (67,'Hipertensão',1,4,6,'V','15 anos',2),
 (68,'Infarto do miocárdio',1,-1,6,'V','',6),
 (69,'Queimacao',1,5,6,'V','',5),
 (70,'Diarreia',1,-1,6,'V','',14),
 (71,'Impotência',1,-1,6,'V','',8),
 (72,'Diminuição do desejo sexual',1,-1,6,'V','',9),
 (73,'Dor nas costas',1,-1,6,'V','',7),
 (74,'Tendinite',1,-1,6,'V','',11),
 (75,'Dor muscular',1,-1,6,'V','',10),
 (76,'Perda de equilíbrio',1,-1,6,'V','',12),
 (77,'Perda de memória',1,-1,6,'V','',13),
 (78,'Dor',2,-1,6,'V','',1),
 (79,'Alterações visuais',2,-1,6,'V','',13),
 (80,'Glaucoma',2,-1,6,'V','',4),
 (81,'Hiperlipidemia',2,7,6,'V','',3),
 (82,'Hipertensão',2,-1,6,'V','15 anos',2),
 (83,'Infarto do miocárdio',2,-1,6,'V','',6),
 (84,'Impotência',2,-1,6,'V','',6),
 (85,'Diminuição do desejo sexual',2,-1,6,'V','',7),
 (86,'Dor nas costas',2,-1,6,'V','',5),
 (87,'Tendinite',2,-1,6,'V','',8),
 (88,'Dor muscular',2,-1,6,'V','',9),
 (89,'Perda de equilíbrio',2,-1,6,'V','',10),
 (90,'Perda de memória',2,-1,6,'V','',11),
 (91,'Alteração de peso',1,1,7,'V','',4),
 (92,'Dor',1,-1,7,'V','',8),
 (93,'Tonteira',1,-1,7,'V','',13),
 (94,'Edema',1,-1,7,'V','',9),
 (95,'Alterações visuais',1,-1,7,'V','',14),
 (96,'Dor no peito',1,-1,7,'V','',15),
 (97,'Hiperlipidemia',1,4,7,'V','',3),
 (98,'Hipertensão',1,7,7,'V','',2),
 (99,'Queimacao',1,-1,7,'V','',5),
 (100,'Náusea',1,-1,7,'V','',16),
 (101,'Diabetes',1,3,7,'V','',1),
 (102,'Dor nas costas',1,-1,7,'V','',10),
 (103,'Artrite',1,-1,7,'V','',11),
 (104,'Tendinite',1,-1,7,'V','',12),
 (105,'Parestesia',1,-1,7,'V','',17),
 (106,'Perda de equilíbrio',1,-1,7,'V','',18),
 (107,'Depressão',1,-1,7,'V','',6),
 (108,'Ansiedade',1,-1,7,'V','',7),
 (109,'Alteração de peso',2,-1,7,'V','',0),
 (110,'Dor',2,-1,7,'V','',0),
 (111,'Tonteira',2,-1,7,'V','',0),
 (112,'Edema',2,-1,7,'V','',0),
 (113,'Alterações visuais',2,-1,7,'V','',0),
 (114,'Dor no peito',2,-1,7,'V','',0),
 (115,'Hiperlipidemia',2,-1,7,'V','',0),
 (116,'Hipertensão',2,-1,7,'V','',0),
 (117,'Queimacao',2,5,7,'V','',0),
 (118,'Náusea',2,-1,7,'V','',0),
 (119,'Diabetes',2,3,7,'V','',0),
 (120,'Dor nas costas',2,-1,7,'V','',0),
 (121,'Artrite',2,-1,7,'V','',0),
 (122,'Tendinite',2,-1,7,'V','',0),
 (123,'Parestesia',2,-1,7,'V','',0),
 (124,'Perda de equilíbrio',2,-1,7,'V','',0),
 (125,'Depressão',2,-1,7,'V','',0),
 (126,'Ansiedade',2,-1,7,'V','',0),
 (127,'Alteração de peso',1,-1,8,'V','',8),
 (128,'Dor',1,-1,8,'V','',9),
 (129,'Tonteira',1,-1,8,'V','',10),
 (130,'Zumbido no ouvido',1,-1,8,'V','',11),
 (131,'Dor no peito',1,-1,8,'V','',3),
 (132,'Hipertensão',1,4,8,'V','',1),
 (133,'Diabetes',1,3,8,'V','13 anos',2),
 (134,'Frequência urinária',1,1,8,'V','',6),
 (135,'Dismenorreia',1,-1,8,'V','',12),
 (136,'Incontinência',1,-1,8,'V','',7),
 (137,'Diminuição do desejo sexual',1,-1,8,'V','',13),
 (138,'Formação excessiva de hematomas',1,-1,8,'V','',14),
 (139,'Dor nas costas',1,-1,8,'V','',4),
 (140,'Tendinite',1,-1,8,'V','',5),
 (141,'Parestesia',1,-1,8,'V','',15),
 (142,'Perda de equilíbrio',1,-1,8,'V','',16),
 (143,'Perda de memória',1,-1,8,'V','',17),
 (144,'Alteração de peso',2,-1,8,'V','',8),
 (145,'Dor',2,-1,8,'V','',9),
 (146,'Tonteira',2,-1,8,'V','',10),
 (147,'Zumbido no ouvido',2,-1,8,'V','',11),
 (148,'Dor no peito',2,-1,8,'V','',3),
 (149,'Hipertensão',2,-1,8,'V','',1),
 (150,'Diabetes',2,-1,8,'V','',2),
 (151,'Frequência urinária',2,-1,8,'V','',6),
 (152,'Dismenorreia',2,-1,8,'V','',12),
 (153,'Incontinência',2,-1,8,'V','',7),
 (154,'Diminuição do desejo sexual',2,-1,8,'V','',13),
 (155,'Formação excessiva de hematomas',2,-1,8,'V','',14),
 (156,'Dor nas costas',2,-1,8,'V','',4),
 (157,'Tendinite',2,-1,8,'V','',5),
 (158,'Parestesia',2,-1,8,'V','',15),
 (159,'Perda de equilíbrio',2,-1,8,'V','',16),
 (160,'Perda de memória',2,-1,8,'V','',17),
 (161,'Dor',1,3,9,'V','',1),
 (162,'Edema',1,-1,9,'V','',2),
 (163,'Hipertensão',1,2,9,'V','15 anos',4),
 (164,'Queimacao',1,-1,9,'V','',8),
 (165,'Diabetes',1,4,9,'V','15 anos ',5),
 (166,'Frequência urinária',1,2,9,'V','',6),
 (167,'Impotência',1,-1,9,'V','',9),
 (168,'Diminuição do desejo sexual',1,-1,9,'V','',10),
 (169,'Hemorragia',1,-1,9,'V','',11),
 (170,'Dor nas costas',1,3,9,'V','',3),
 (171,'Dor muscular',1,-1,9,'V','',7),
 (172,'Tremor',1,-1,9,'V','',12),
 (173,'Perda de memória',1,-1,9,'V','',13),
 (174,'Eczema',1,-1,9,'V','',14),
 (175,'Dor',2,-1,9,'','',1),
 (176,'Edema',2,-1,9,'','',2),
 (177,'Hipertensão',2,-1,9,'','15 anos',4),
 (178,'Queimacao',2,-1,9,'','',8),
 (179,'Diabetes',2,-1,9,'','15 anos',5),
 (180,'Impotência',2,-1,9,'','',6),
 (181,'Diminuição do desejo sexual',2,1,9,'','',9),
 (182,'Hemorragia',2,-1,9,'','',10),
 (183,'Dor nas costas',2,-1,9,'','',11),
 (184,'Dor muscular',2,-1,9,'','',3),
 (185,'Tremor',2,-1,9,'','',7),
 (186,'Perda de memória',2,-1,9,'','',12),
 (187,'Eczema',2,-1,9,'','',13);
...
INSERT INTO `queixarespostaprimeira` (`id`,`descricao`,`fkResposta`) VALUES 
 ...
 (7,'hipertensao',4),
 (8,'impotencia',4),
 (9,'diminuicao do desejo sexual',4),
 (10,'perda de memoria',4),
 (11,'dor',5),
 (12,'edema',5),
 (13,'hipertensao',5),
 (14,'diabetes',5),
 (15,'frequencia urinaria',5),
 (16,'impotencia',5),
 (17,'diminuicao do desejo sexual',5),
 (18,'hemorragia',5),
 (19,'dor nas costas',5),
 (20,'dor muscular',5),
 (21,'tremor',5),
 (22,'perda de memoria',5),
 (23,'eczema',5),
 (24,'dor',6),
 (25,'tonteira',6),
 (26,'edema',6),
 (27,'alteracoes visuais',6),
 (28,'diminuicao da audicao',6),
 (29,'rinite alergica',6),
 (30,'hiperlipidemia',6),
 (31,'hipertensao',6),
 (32,'falta de ar',6),
 (33,'queimacao',6),
 (34,'frequencia urinaria',6),
 (35,'anemia',6),
 (36,'dor nas costas',6),
 (37,'dor muscular',6),
 (38,'parestesia',6),
 (39,'perda de equilibrio',6),
 (40,'depressao',6),
 (41,'ansiedade',6),
 (42,'alteracao de peso',7),
 (43,'dor',7),
 (44,'tonteira',7),
 (45,'zumbido no ouvido',7),
 (46,'dor no peito',7),
 (47,'hipertensao',7),
 (48,'diabetes',7),
 (49,'frequencia urinaria',7),
 (50,'dismenorreia',7),
 (51,'incontinencia',7),
 (52,'diminuicao do desejo sexual',7),
 (53,'formacao excessiva de hematomas',7),
 (54,'dor nas costas',7),
 (55,'tendinites',7),
 (56,'parestesia',7),
 (57,'perda de equilibrio',7),
 (58,'perda de memoria',7),
 (59,'alteracao de peso',8),
 (60,'dor',8),
 (61,'tonteira',8),
 (62,'edema',8),
 (63,'alteracoes visuais',8),
 (64,'dor no peito',8),
 (65,'hiperlipidemia',8),
 (66,'hipertensao',8),
 (67,'queimacao',8),
 ...
 (72,'tendinites',8),
 (73,'parestesia',8),
 (74,'perda de equilibrio',8),
 (75,'depressao',8),
 (76,'ansiedade',8),
 (77,'dor',9),
 (78,'alteracoes visuais',9),
 (79,'glaucoma',9),
 (80,'hiperlipidemia',9),
 (81,'hipertensao',9),
 (82,'infarto do miocardio',9),
 (83,'queimacao',9),
 (84,'diarreia',9),
 (85,'frequencia urinaria',9),
 (86,'impotencia',9),
 (87,'diminuicao do desejo sexual',9),
 (88,'dor nas costas',9),
 (89,'tendinites',9),
 (90,'dor muscular',9),
 (91,'perda de equilibrio',9),
 (92,'perda de memoria',9),
 (93,'perda de apetite',10),
 (94,'perda de apetite',11),
 (95,'hiperlipidemia',12),
 (96,'hipertensao',12),
 (97,'impotencia',12),
 (98,'diminuicao do desejo sexual',12),
 (99,'perda de memoria',12),
 (100,'dor',13),
 (101,'edema',13),
 (102,'hiperlipidemia',13),
 (103,'hipertensao',13),
 (104,'diabetes',13),
 (105,'frequencia urinaria',13),
 (106,'impotencia',13),
 (107,'diminuicao do desejo sexual',13),
 (108,'hemorragia',13),
 (109,'dor nas costas',13),
 (110,'dor muscular',13),
 (111,'tremor',13),
 (112,'perda de memoria',13),
 (113,'eczema',13),
 (114,'dor',14),
 (115,'alteracoes visuais',14),
 (116,'glaucoma',14),
 (117,'hiperlipidemia',14),
 (118,'hipertensao',14),
 (119,'infarto do miocardio',14),
 (120,'queimacao',14),
 (121,'diarreia',14),
 (122,'impotencia',14),
 (123,'diminuicao do desejo sexual',14),
 (124,'dor nas costas',14),
 (125,'tendinites',14),
 (126,'dor muscular',14),
 (127,'perda de equilibrio',14),
 (128,'perda de memoria',14),
 (129,'dor',15),
 (130,'edema',15),
 (131,'hiperlipidemia',15),
 (132,'hipertensao',15),
 (133,'diabetes',15),
 (134,'frequencia urinaria',15),
 (135,'impotencia',15),
 (136,'diminuicao do desejo sexual',15),
 (137,'hemorragia',15),
 (138,'dor nas costas',15),
 (139,'dor muscular',15),
 (140,'tremor',15),
 (141,'perda de memoria',15),
 (142,'eczema',15),
 (143,'dor',16),
 (144,'tonteira',16),
 (145,'edema',16),
 (146,'alteracoes visuais',16),
 (147,'diminuicao da audicao',16),
 (148,'rinite alergica',16),
 (149,'hiperlipidemia',16),
 (150,'hipertensao',16),
 (151,'falta de ar',16),
 (152,'queimacao',16),
 (153,'frequencia urinaria',16),
 (154,'anemia',16),
 (155,'dor nas costas',16),
 (156,'dor muscular',16),
 (157,'parestesia',16),
 (158,'perda de equilibrio',16),
 (159,'depressao',16),
 (160,'ansiedade',16),
 (161,'perda de memoria',16);
...
INSERT INTO `queixarespostasegunda` (`id`,`numeroPRM`,`fkResposta2`,`flConheceOuPreocupa`,`prioridade`,`descricao`,`periodoSurgimento`) VALUES 
 (33,-1,8,'V',5,'Hiperlipidemia','1974'),
 (34,-1,8,'V',6,'Hipertensão','1974'),
 (35,-1,8,'V',2,'Diabetes','2008 (Pré-diabetes)'),
 (36,5,8,'V',1,'Impotência','1999'),
 (37,5,8,'V',3,'Diminuição do desejo sexual','1999'),
 (38,5,8,'V',4,'Perda de memória','1999'),
 (53,-1,10,'V',1,'Dor',''),
 (54,5,10,'V',1,'Edema',''),
 (55,-1,10,'',2,'Hipertensão',''),
 (56,1,10,'V',1,'Queimacao',''),
 (57,-1,10,'V',2,'Diabetes',''),
 (58,-1,10,'V',2,'Frequência urinária',''),
 (59,1,10,'V',0,'Impotência',''),
 (60,1,10,'V',0,'Diminuição do desejo sexual',''),
 (61,1,10,'',0,'Hemorragia',''),
 (62,-1,10,'',0,'Dor nas costas',''),
 (63,-1,10,'',0,'Dor muscular',''),
 (64,-1,10,'',0,'Tremor',''),
 (65,-1,10,'',0,'Perda de memória',''),
 (66,1,10,'',0,'Eczema',''),
 (85,-1,12,'V',17,'Alteração de peso',''),
 (86,-1,12,'V',11,'Dor',''),
 (87,5,12,'V',2,'Tonteira',''),
 (88,-1,12,'V',1,'Zumbido no ouvido',''),
 (89,-1,12,'V',5,'Dor no peito',''),
 (90,-1,12,'V',15,'Hipertensão',''),
 (91,-1,12,'V',14,'Diabetes',''),
 (92,-1,12,'V',6,'Frequência urinária',''),
 (93,5,12,'V',16,'Dismenorreia',''),
 (94,-1,12,'V',7,'Incontinência',''),
 (95,-1,12,'V',12,'Diminuição do desejo sexual',''),
 (96,1,12,'V',13,'Formação excessiva de hematomas',''),
 (97,5,12,'V',9,'Dor nas costas',''),
 (98,-1,12,'V',8,'Tendinite',''),
 (99,5,12,'V',4,'Parestesia',''),
 (100,5,12,'V',3,'Perda de equilíbrio',''),
 (101,-1,12,'V',10,'Perda de memória',''),
 (391,5,30,'V',13,'Alteração de peso',''),
 (392,-1,30,'V',2,'Dor',''),
 (393,5,30,'V',8,'Tonteira',''),
 (394,5,30,'V',7,'Edema',''),
 (395,5,30,'V',14,'Alterações visuais',''),
 (396,4,30,'V',6,'Dor no peito',''),
 (397,-1,30,'V',16,'Hiperlipidemia',''),
 (398,-1,30,'V',17,'Hipertensão',''),
 (399,5,30,'V',12,'Queimacao',''),
 (400,3,30,'V',11,'Náusea',''),
 (401,7,30,'V',1,'Diabetes',''),
 (402,-1,30,'V',5,'Dor nas costas',''),
 (403,2,30,'V',4,'Artrite',''),
 (404,2,30,'V',3,'Tendinite',''),
 (405,-1,30,'V',15,'Parestesia',''),
 (406,-1,30,'V',18,'Perda de equilíbrio',''),
 (407,3,30,'V',9,'Depressão',''),
 (408,3,30,'V',10,'Ansiedade',''),
 (409,-1,31,'V',3,'Dor',''),
 (410,-1,31,'V',4,'Edema',''),
 (411,-1,31,'V',5,'Alterações visuais',''),
 (412,-1,31,'V',6,'Diminuição da audição',''),
 (413,-1,31,'V',7,'Rinite alergica',''),
 (414,1,31,'F',1,'Hiperlipidemia',''),
 (415,7,31,'F',2,'Hipertensão',''),
 (416,-1,31,'V',8,'Falta de ar',''),
 (417,-1,31,'V',9,'Queimacao',''),
 (418,-1,31,'V',10,'Anemia',''),
 (419,-1,31,'V',11,'Dor nas costas',''),
 (420,-1,31,'F',12,'Parestesia',''),
 (421,-1,31,'V',13,'Perda de equilíbrio',''),
 (422,-1,31,'V',14,'Depressão',''),
 (423,-1,31,'V',15,'Ansiedade',''),
 (424,-1,31,'V',16,'Perda de memória',''),
 (425,-1,32,'V',3,'Dor',''),
 (426,-1,32,'V',13,'Alterações visuais',''),
 (427,-1,32,'V',15,'Glaucoma',''),
 (428,-1,32,'V',2,'Hiperlipidemia',''),
 (429,-1,32,'V',12,'Hipertensão','Diagnosticada há 15 anos'),
 (430,-1,32,'V',14,'Infarto do miocárdio',''),
 (431,0,32,'V',7,'Queimacao',''),
 (432,0,32,'V',6,'Diarreia',''),
 (433,0,32,'V',8,'Impotência',''),
 (434,0,32,'V',9,'Diminuição do desejo sexual',''),
 (435,0,32,'V',5,'Dor nas costas',''),
 (436,0,32,'V',1,'Tendinite',''),
 (437,0,32,'V',4,'Dor muscular',''),
 (438,0,32,'V',11,'Perda de equilíbrio',''),
 (439,-1,32,'V',10,'Perda de memória',''),
 (440,1,33,'F',1,'Hiperlipidemia','das'),
 (441,-1,33,'V',3,'Hipertensão','d'),
 (442,1,33,'V',2,'Diabetes',''),
 (443,-1,33,'F',4,'Impotência','d'),
 (444,-1,33,'F',6,'Diminuição do desejo sexual',''),
 (445,-1,33,'F',5,'Perda de memória','d'),
 (446,0,34,'',0,'Hiperlipidemia',''),
 (447,0,34,'',0,'Hipertensão',''),
 (448,0,34,'',0,'Diabetes',''),
 (449,0,34,'',0,'Impotência',''),
 (450,0,34,'',0,'Diminuição do desejo sexual',''),
 (451,0,34,'',0,'Perda de memória','');
...
INSERT INTO `turma` (`id`,`codigo`,`periodo`,`fktutor`,`nmDisciplina`) VALUES 
 (1,'A0','2010.1','monique','Atenção Farmacêutica - UFS');
...
INSERT INTO `tutor` (`login`,`nome`) VALUES 
 ('danieltenorio','Daniel Tenório'),
 ('Giselle Brito','Giselle de Carvalho Brito'),
 ('monique','Monique Oliveira Jabbur Lopes'),
 ('rafael','José Rafael');
...
INSERT INTO `usuario` (`login`,`email`,`senha`,`tpUsuario`,`nome`) VALUES 
 (' Nelson','nelsonfarma@gmail.com','1234','Aluno','Nelson Rubens Moreira'),
 ('admin','admin@gmail.com','!p4c1ent3','Administrador','Administrador'),
 ('aline','alineufs@hotmail.com','cel8144','Aluno','Aline de Oliveira Lima'),
 ('araujo_bes','araujo_bes@hotmail.com','besa2020','Aluno','Bruno Eduardo Silva de Araújo'),
 ('bernardo','bernardo_jabbur@hotmail.com','12345','Aluno','Bernardo'),
 ('cledison','galego169@hotmail.com','csr838840','Aluno','cledison santos ramos'),
 ('Daniela Araujo','danielaju@bol.com.br','dani0305','Aluno','Daniela Araujo Melo'),
 ('danieltenorio','danieltenorio.lepfs@hotmail.com','riobranco08','Tutor',NULL),
 ('ericafabianne','efabianne@yahoo.com.br','3r1c4','Aluno','Érica Fabianne Oliveira Souza'),
 ('Gi','gisellecbrito@hotmail.com','300586','Aluno','Giselle Brito'),
 ('Giselle Brito','gigilbrito@hotmail.com','3020526','Tutor',NULL),
 ('Joana Luiza ','joanaluiza@ig.com.br','846464','Aluno','Joana Luiza Costa Almeida'),
 ('johnny.farma','johnny.farma@yahoo.com.br','soeusei','Aluno','João Luiz Alves dos Santos'),
 ('Juliana','jualmeida_ufs@yahoo.com.br','100986','Aluno','Juliana Almeida Ferreira'),
 ('Júnior','kal_el_jr@hotmail.com','1234','Aluno','Genival Araújo dos Santos Júnior'),
 ('laiane vasconcelos','laianevasconcelos@hotmail.com','06121851','Aluno','laiane tiara santos vasconcelos'),
 ('Laís Sena','laiscris4@hotmail.com','101010','Aluno','Laís Cristina Santana Sena'),
 ('Larissa Carvalho','laricarvalho87@gmail.com','870106','Aluno','Larissa Feitosa Carvalho'),
 ('maksonoliveira','makson_gbo@hotmail.com','MAKFARMAUFS','Aluno','MAKSON GLEYDSON BRITO DE OLIVEIRA'),
 ('Marcos','mdseabra87@hotmail.com','123456','Aluno','Marcos Daniel Seabra Santos'),
 ('monique','moniquejabbur@hotmail.com','220735','Tutor',NULL),
 ('Nayanna Lessa','nay_lessa@hotmail.com','nanaedi2703','Aluno','Nayanna Mendes Neves Lessa'),
 ('rafael','jrafaelns1@gmail.com','teste','Tutor',NULL),
 ('Renata','renathinhasouza2008@hotmail.com','260802','Aluno','Renata Souza de Carvalho'),
 ('tamireslima','tam_tamires@yahoo.com.br','gigi1901','Aluno','Tamires Cardoso Lima'),
 ('Thais Teles','thaisteles1@hotmail.com','na08nae03','Aluno','Thaís Teles de Souza'),
 ('Vinícius','vinicius_c.c@hotmail.com','cviper235','Aluno','Carlos Vinícius Costa da Conceição'),
 ('vivianne','vivianneufs@hotmail.com','232530','Aluno','Vivianne Freire Santos');
