...
CREATE TABLE `tb_consulta_parametro` (
  ...
  KEY `fk_tb_consulta_variavel_has_tb_parametro_clinico_tb_parametro1` (`IdParamentoClinico`),
  ...
  CONSTRAINT `fk_tb_consulta_variavel_has_tb_parametro_clinico_tb_parametro1` FOREIGN KEY (`IdParamentoClinico`) REFERENCES `tb_parametro_clinico` (`IdParamentoClinico`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_instituicao` VALUES (0,'Universidade Federa de Sergipe','UFS');
...
INSERT INTO `tb_plano_saude` VALUES (0,'unimed brasil');
...
INSERT INTO `my_aspnet_sessioncleanup` VALUES ('2013-06-18 15:21:35',10,1);
...
CREATE TABLE `tb_consulta_variavel` (
  ...
  KEY `fk_tb_consulta_variavel_tb_consulta_fixo1` (`IdConsutaFixo`),
  KEY `fk_tb_consulta_variavel_tb_turma_pessoa_relato1` (`IdTurma`,`IdPessoa`,`IdRelato`),
  CONSTRAINT `fk_tb_consulta_variavel_tb_consulta_fixo1` FOREIGN KEY (`IdConsutaFixo`) REFERENCES `tb_consulta_fixo` (`IdConsutaFixo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `my_aspnet_applications` VALUES (1,'/','MysqlSessionState');
...
CREATE TABLE `tb_diario_pessoal` (
  ...
  CONSTRAINT `fk_tb_diario_pessoal_tb_consulta_fixo1` FOREIGN KEY (`IdConsutaFixo`) REFERENCES `tb_consulta_fixo` (`IdConsutaFixo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `my_aspnet_sessions` VALUES ('2pcbp1cy5xttym4jkfvu5r2v',1,'2013-06-18 15:27:04','2013-06-18 15:47:04','2013-06-18 15:27:04',1,20,0,NULL,0),('4c5ao5mukwtjlgqvthw0yztx',1,'2013-06-18 15:22:15','2013-06-18 15:42:28','2013-06-18 15:22:28',5,20,0,NULL,0),('5xmr4lftib2eyfqlexgvai2f',1,'2013-06-18 15:26:59','2013-06-18 15:46:59','2013-06-18 15:26:59',1,20,0,NULL,0),('5yi3gfdloi5sj5wvjn02a5tq',1,'2013-06-18 15:26:56','2013-06-18 15:46:56','2013-06-18 15:26:56',1,20,0,NULL,0),('chroxbhxi5jqtj12ub2zstns',1,'2013-06-18 15:21:54','2013-06-18 15:41:54','2013-06-18 15:21:54',1,20,0,NULL,0),('dcprr3bytezackc3hcqp2jpl',1,'2013-06-18 15:22:33','2013-06-18 15:42:33','2013-06-18 15:22:33',1,20,0,NULL,0),('jjirlv2km5wfbounveyqbohu',1,'2013-06-18 15:22:03','2013-06-18 15:42:12','2013-06-18 15:22:12',4,20,0,NULL,0),('mapjjbtt0r0sshaamivo1b5u',1,'2013-06-18 15:21:35','2013-06-18 15:41:50','2013-06-18 15:21:50',4,20,0,NULL,0),('mbbwtbnbklad1j2ydbuckw42',1,'2013-06-18 15:21:39','2013-06-18 15:41:39','2013-06-18 15:21:39',1,20,0,NULL,0),('mrdjeiui0li0t435xj3i3i4k',1,'2013-06-18 15:27:34','2013-06-18 15:47:34','2013-06-18 15:27:34',1,20,0,NULL,0),('wmn41ybj3vsoqb0rtym01upv',1,'2013-06-18 15:26:44','2013-06-18 15:46:51','2013-06-18 15:26:50',3,20,0,NULL,0),('x2c0wjody5pbglcjunmvcqd3',1,'2013-06-18 15:27:30','2013-06-18 15:47:30','2013-06-18 15:27:30',1,20,0,NULL,0);
...
-- Dump completed on 2013-06-18 15:56:56
