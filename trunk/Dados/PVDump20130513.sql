...
CREATE TABLE `tb_razao_encontro` (
  `IdConsultaVariavel` bigint(20) NOT NULL,
  `IdRespostaRazaoEncontro` int(11) NOT NULL,
  PRIMARY KEY (`IdConsultaVariavel`),
  KEY `fk_tb_razao_encontro_tb_resposta1` (`IdRespostaRazaoEncontro`),
  CONSTRAINT `fk_tb_razao_encontro_tb_consulta_variavel1` FOREIGN KEY (`IdConsultaVariavel`) REFERENCES `tb_consulta_variavel` (`IdConsultaVariavel`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_razao_encontro_tb_resposta1` FOREIGN KEY (`IdRespostaRazaoEncontro`) REFERENCES `tb_resposta` (`IdResposta`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tb_paciente_pessoa_turma`
--

DROP TABLE IF EXISTS `tb_paciente_pessoa_turma`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_paciente_pessoa_turma` (
  `IdPessoa` int(11) NOT NULL,
  `IdTurma` int(11) NOT NULL,
  `IdPaciente` int(11) NOT NULL,
...
--
-- Dumping data for table `tb_paciente_pessoa_turma`
--

LOCK TABLES `tb_paciente_pessoa_turma` WRITE;
/*!40000 ALTER TABLE `tb_paciente_pessoa_turma` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_paciente_pessoa_turma` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tb_exames_fisicos` (
  ...
  `IdAlergia` int(11) NOT NULL,
  PRIMARY KEY (`IdConsultaVariavel`),
  KEY `fk_tb_exames_fisicos_tb_alergia1` (`IdAlergia`),
  ...
  CONSTRAINT `fk_tb_exames_fisicos_tb_alergia1` FOREIGN KEY (`IdAlergia`) REFERENCES `tb_alergia` (`IdAlergia`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_consulta_variavel` (
  ...
  `EhGabarito` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`IdConsultaVariavel`),
  KEY `fk_tb_consulta_variavel_tb_relato_clinico1` (`IdRelato`),
  CONSTRAINT `fk_tb_consulta_variavel_tb_relato_clinico1` FOREIGN KEY (`IdRelato`) REFERENCES `tb_relato_clinico` (`IdRelato`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
