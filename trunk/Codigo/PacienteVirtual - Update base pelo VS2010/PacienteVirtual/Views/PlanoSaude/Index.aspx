...
<% foreach (var item in Model) { %>
    <tr>
        ...
        <td>
            <%: Html.ActionLink("Edit", "Edit", new { id=item.IdPlanoSaude }) %> |
            <%: Html.ActionLink("Details", "Details", new { id=item.IdPlanoSaude }) %> |
            <%: Html.ActionLink("Delete", "Delete", new { id=item.IdPlanoSaude }) %>
        </td>
    </tr>
<% } %>
