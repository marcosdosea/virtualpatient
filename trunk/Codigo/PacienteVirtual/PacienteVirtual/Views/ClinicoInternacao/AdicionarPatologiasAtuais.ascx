<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<PacienteVirtual.Models.PatologiasAtuaisModel>" %>
<%@ Import Namespace = "PacienteVirtual.Helpers" %>

<% using (Html.BeginForm("AdicionarPatologiasAtuais", "ClinicoInternacao"))
   { %>
...
<div class="span5">
    <%: Html.ValidationMessageFor(model => model.ErroPatologiasAtuais, string.Empty, new { @class = "styleValidation" })%>
</div>
<% } %>
