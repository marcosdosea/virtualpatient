...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        <legend>
            <%: Resources.Mensagem.religiao %></legend>
        <%: Html.HiddenFor(model => model.IdReligiao) %>
        <div class="editor-label">
            <%: Html.LabelFor(model => model.Religiao) %>
        </div>
        <div class="editor-field">
            <%: Html.TextBoxFor(model => model.Religiao, new { style = "width:350px;", MaxLength = 45 })%>
            <%: Html.ValidationMessageFor(model => model.Religiao) %>
        </div>
