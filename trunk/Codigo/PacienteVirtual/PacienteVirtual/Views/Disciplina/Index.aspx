...
<%= Html.Grid(Model).Columns(columns =>
    {
        ...
        columns.Add()
                ...
                .Sanitized(false)
                .SetWidth(30)
                .RenderValueAs(o => Html.ActionLink(Resources.Mensagem.editar, "Edit", new { id = o.IdDisciplina }, new { @class = "modal-link" }));
        ...
        columns.Add()
                ...
                .Sanitized(false)
                .SetWidth(30)
                .RenderValueAs(o => Html.ActionLink(Resources.Mensagem.detalhes, "Details", new { id = o.IdDisciplina }, new { @class = "modal-link" }));
        ...
        columns.Add()
                ...
                .Sanitized(false)
                .SetWidth(30)
                .RenderValueAs(o => Html.ActionLink(Resources.Mensagem.remover, "Delete", new { id = o.IdDisciplina }, new { @class = "modal-link" }));
