		...
		<h:panelGroup layout="block" id="conteudo" styleClass="conteudo">
			...
			<h:panelGroup layout="block" id="wraper" styleClass="wraper">
				<h:panelGroup layout="block" id="mainContent"
					...
					<br><h2><h:outputText value="#{bundle.cadastroTurma}"></h:outputText></h2><br><br>
			
		<h:commandLink action="AdicionarTurma">
			<h:outputText value="#{bundle.adicionarTurma}"></h:outputText>
		</h:commandLink><br>
		<h:commandLink action="AlocarAlunos">
			<h:outputText value="#{bundle.alocarAlunos}"></h:outputText>
		</h:commandLink>
		<br><br>
		<a href="menuTutor.jsp">
