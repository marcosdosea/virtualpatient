...
<h:panelGroup layout="block" id="tudo" styleClass="tudo">
	<h:panelGroup layout="block" id="conteudo" styleClass="conteudo">
		...
		<h:selectOneMenu value="#{casoClinicoBean.casoConsultadoAuxStr}">
			<f:selectItems value="#{casoClinicoBean.listaCasosByIdioma}"></f:selectItems>
		</h:selectOneMenu>
			<h:commandButton value="#{bundle.escolher}" action="#{casoClinicoBean.Escolher}"></h:commandButton>
		</h:panelGrid>
