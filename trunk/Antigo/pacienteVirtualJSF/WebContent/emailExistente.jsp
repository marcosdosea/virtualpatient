...
<f:view>
	...
	<h:outputText value="#{bundle.emailExistente}"></h:outputText>
	<br>
	<h:outputText value="#{bundle.recuperarDados}"></h:outputText>
	<a href="recuperandoSenha.jsp">
	<h:outputText value="#{bundle.aqui}"></h:outputText></a>
		</h:panelGroup>
			</h:panelGroup>
