		...
		<h:panelGroup layout="block" id="conteudo" styleClass="conteudo">
			...
			<h:panelGroup layout="block" id="wraper" styleClass="wraper">
				<h:panelGroup layout="block" id="mainContent"
					...
					<big><b><h:outputText value="#{bundle.escolhaOpcao}"></h:outputText></b></big><br/>
					<br>
					<h:panelGrid border="0" columns="2" style="width: 508px">
						<h:selectOneMenu value="#{opcoesBean.opcaoEscolhida}">
							<f:selectItems value="#{opcoesBean.listaOpcoes}" />
						</h:selectOneMenu>
						<br><br>
						<h:commandButton value="#{bundle.escolher}" action="#{opcoesBean.escolher}"></h:commandButton>
					</h:panelGrid>
					<br><br>
