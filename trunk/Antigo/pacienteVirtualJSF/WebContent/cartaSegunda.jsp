...
<h:form>
	...
	<h:panelGroup id="relatos" layout="block" styleClass="field">
			<br><h:inputTextarea value="#{respostaDoAluno2Bean.carta}" style="height: 150px" styleClass="field_text"></h:inputTextarea><br>
		</h:panelGroup>
	</fieldset><br>
		<h:commandButton value="OK" action="#{respostaDoAluno2Bean.salvandoCarta}"></h:commandButton>
		</h:panelGroup>
