...
<h:panelGroup layout="block" id="tudo" styleClass="tudo">
	...
	<h:outputText value="#{bundle.bemvindoAdm}"></h:outputText> 
	<h:outputText value="#{usuarioBean.nome}"></h:outputText><br><br>
		<h:commandLink action="cadastrar Tutor">
			<h:graphicImage value="#{bundle.bntCadastrarTutor}" style="border: 0" alt="#{bundle.altCadastrarTutor}"></h:graphicImage>
		</h:commandLink>
