...
/**
 * The persistent class for the experienciamedicamentos3caso database table.
 * 
 */
@Entity
@Table(name="experienciamedicamentos3caso")

public class ExperienciaMedicamentos3Caso implements Serializable {
    ...
    public ExperienciaMedicamentos3Caso(){    	
    }
