...
/**
 * The persistent class for the medicamentoqueixa database table.
 * 
 */
@Entity
@Table(name="medicamentoqueixa")
public class MedicamentoQueixa implements Serializable {
	...
	//bi-directional many-to-one association to Queixa
    @ManyToOne
	@JoinColumn(name="fkQueixa")
	private Queixa queixa;

    public MedicamentoQueixa() {
    }
