...
/**
 * The persistent class for the experienciamedicamentos2caso database table.
 * 
 */
@Entity
@Table(name="experienciamedicamentos2caso")

public class ExperienciaMedicamentos2Caso implements Serializable {
    ...
    public ExperienciaMedicamentos2Caso(){    	
    }
