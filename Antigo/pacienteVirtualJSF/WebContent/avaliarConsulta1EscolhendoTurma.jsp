...
<h:panelGroup layout="block" id="tudo" styleClass="tudo">
	<h:panelGroup layout="block" id="conteudo" styleClass="conteudo">
		...
		<h:panelGroup layout="block" id="wraper" styleClass="wraper">
			...
			<big><b><h:outputText value="#{bundle.escolhaTurma}"></h:outputText></b></big><br/>
			<h:panelGrid border="0" columns="2" style="width: 508px">
				<h:selectOneMenu value="#{avaliarConsultaBean.turmaEscolhidaAux}">
					<f:selectItems value="#{avaliarConsultaBean.opcoesTurma}"/>
				</h:selectOneMenu>
					<h:commandButton value="OK" action="#{avaliarConsultaBean.escolherTurma}"/>
			</h:panelGrid>
