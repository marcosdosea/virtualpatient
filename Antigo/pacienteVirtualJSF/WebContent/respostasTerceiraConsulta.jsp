...
<h:panelGroup layout="block" id="tudo" styleClass="tudo">
	<h:panelGroup layout="block" id="conteudo" styleClass="conteudo">
		...
		<br>
		<h:outputText value="#{respostaDoAluno3Bean.respostaTerceira.comentarioAluno}"></h:outputText>
		<br>
		...
		<h:dataTable value="#{respostaDoAluno3Bean.listaGabarito3}" var="currentQueixaResposta" >
			<h:column>
			<h:panelGrid columns="1">
		...
		<h:dataTable value="#{respostaDoAluno3Bean.listaAluno3}" var="currentQueixaResposta" >
			<h:column>
			<h:panelGrid columns="1">
		...
		<h:panelGroup id="proxEncontro" layout="block" styleClass="field">	
			...
			<h:inputTextarea style="height: 140px" readonly="true"
						value="#{respostaDoAluno3Bean.respostaTerceira.consulta.fkCasoClinico.proxEncontro}"
						styleClass="field_text"></h:inputTextarea>	
			<br><br>
			<h:outputText value="#{bundle.respostaAluno}"  style="font-weight: bold"></h:outputText>
			<br><br>
			<h:inputTextarea style="height: 140px" readonly="true"
						value="#{respostaDoAluno3Bean.respostaTerceira.proxEncontro}"
						styleClass="field_text"></h:inputTextarea>			
		</h:panelGroup>	
		</fieldset>
		<br>
		...
		<h:panelGroup id="diarioPessoalMed" layout="block" styleClass="field">	
			<h:outputText value="#{bundle.resposta}" style="font-weight: bold"></h:outputText>
			<br><br>
			<h:dataTable value="#{respostaDoAluno3Bean.listaDiarioMedGabaritoTerceira}"
				rendered="#{not empty respostaDoAluno3Bean.listaDiarioMedGabaritoTerceira}"
			...
			<h:outputText value="#{bundle.respostaAluno}" style="font-weight: bold"></h:outputText>
			<br><br>
			<h:dataTable value="#{respostaDoAluno3Bean.listaDiarioMedRespostaAlunoTerceira}"
				rendered="#{not empty respostaDoAluno3Bean.listaDiarioMedRespostaAlunoTerceira}"
				var="currentParametro" styleClass="dataTables" 
				headerClass="headerDataTable" rowClasses="odd, even">			
				<h:column id="column1">
					<h:outputText value="#{currentParametro.periodo}" />
