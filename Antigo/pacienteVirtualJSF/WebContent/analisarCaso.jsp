...
<h:panelGroup layout="block" id="tudo" styleClass="tudo">
	<h:panelGroup layout="block" id="conteudo" styleClass="conteudo">
		...
		<h:panelGrid border="1" columns="2" style="width: 508px" headerClass="headerDataTable" rowClasses="odd, even">
		<f:facet name="header">
			<h:outputText value="#{bundle.escolhaCaso}"></h:outputText>
		</f:facet>
		<h:selectOneMenu value="#{respostaDoAlunoBean.casoEscolhidoAuxStr}">
			<f:selectItems value="#{respostaDoAlunoBean.listaCasosByIdioma}"></f:selectItems>
		</h:selectOneMenu>
			<h:commandButton value="#{bundle.escolher}" action="#{respostaDoAlunoBean.Escolher}"></h:commandButton>
		</h:panelGrid>
