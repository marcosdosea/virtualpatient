...
<h:panelGroup layout="block" id="tudo" styleClass="tudo">
		...
		<h:dataTable border="1" value="#{tutorBean.all}" var="currentTutor"
				styleClass="dataTables">
			<h:column id="column1">
				<h:outputText value="#{currentTutor.tbusuario.login}"></h:outputText>
				<f:facet name="header">
					<h:outputText value="#{bundle.login2}"></h:outputText>
				</f:facet>
			</h:column>
			<h:column id="column2">
				<h:outputText value="#{currentTutor.tbusuario.senha}"></h:outputText>
				<f:facet name="header">
					<h:outputText value="#{bundle.senha}"></h:outputText>
				</f:facet>
			</h:column>
			<h:column id="column3">
				<h:outputText value="#{currentTutor.tbusuario.nome}"></h:outputText>
				<f:facet name="header">
					<h:outputText value="#{bundle.nome2}"></h:outputText>
				</f:facet>
			</h:column>
			<h:column id="column4">
				<h:outputText value="#{currentTutor.tbusuario.email}"></h:outputText>
				<f:facet name="header">
					<h:outputText value="#{bundle.email2}"></h:outputText>
				</f:facet>
			</h:column>
		</h:dataTable>	
