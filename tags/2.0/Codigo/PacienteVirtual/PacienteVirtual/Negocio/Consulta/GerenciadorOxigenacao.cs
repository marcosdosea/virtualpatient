...
namespace PacienteVirtual.Negocio
{
    public class GerenciadorOxigenacao
    {
        ...
        public void CorrigirRespostas(OxigenacaoModel oxigenacao, OxigenacaoModel oxigenacaoGabarito, ModelStateDictionary modelState)
        {
            ...
            if (oxigenacao.AspectoSecrecao != oxigenacaoGabarito.AspectoSecrecao)
            {
                modelState.AddModelError("AspectoSecrecao", "Gabarito: \"" + oxigenacaoGabarito.AspectoSecrecao.ToString() + "\"");
            }
        ...
        private IQueryable<OxigenacaoModel> GetQuery()
        {
            ...
            var query = from oxigenacao in pvEntities.tb_oxiginecao
                        select new OxigenacaoModel
                        {
                            ...
                            TiposTorax =  (oxigenacao.TiposTorax == "Barril" ? ListaTiposTorax.Barril : (oxigenacao.TiposTorax == "PeitoDePombo" ? ListaTiposTorax.PeitoDePombo : (oxigenacao.TiposTorax == "Funil" ? ListaTiposTorax.Funil : (oxigenacao.TiposTorax == "Lordose" ? ListaTiposTorax.Lordose : (oxigenacao.TiposTorax == "Cifose" ? ListaTiposTorax.Cifose : (oxigenacao.TiposTorax == "Escoliose" ? ListaTiposTorax.Escoliose : ListaTiposTorax.Normal)))))),
