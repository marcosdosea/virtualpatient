		...
		<h:panelGroup layout="block" id="conteudo" styleClass="conteudo">
			...
			<h:panelGroup layout="block" id="wraper" styleClass="wraper">
				<h:panelGroup layout="block" id="mainContent"
					...
					<br><h2><h:outputText value="#{bundle.recuperandoSenha}"></h:outputText></h2><br><br>
					<h:form>
						<h:panelGrid border="0" columns="2">
							<h:outputText value="#{bundle.email}"></h:outputText>
							<h:inputText value="#{recuperandoSenhaBean.email}"></h:inputText>
						</h:panelGrid><br>
						<h:commandButton value="#{bundle.enviar}"
							action="#{recuperandoSenhaBean.recuperar}"></h:commandButton>
					</h:form>
				</h:panelGroup>
