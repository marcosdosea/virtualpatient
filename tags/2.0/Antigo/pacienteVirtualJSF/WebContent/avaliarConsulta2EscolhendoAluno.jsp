	...
	<h:panelGroup layout="block" id="conteudo" styleClass="conteudo">
		...
		<h:panelGroup layout="block" id="wraper" styleClass="wraper">
			...
			<h:panelGrid border="0" columns="2" style="width: 508px">
				<h:selectOneMenu value="#{avaliarConsultaBean.alunoEscolhidoAux}">
					<f:selectItems value="#{avaliarConsultaBean.opcoesAluno}" />
				</h:selectOneMenu>
					<h:commandButton value="OK" action="#{avaliarConsultaBean.escolherAluno}"></h:commandButton>
			</h:panelGrid>
