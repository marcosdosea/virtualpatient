		...
		<h:panelGroup layout="block" id="conteudo" styleClass="conteudo">
			...
			<h:panelGroup layout="block" id="wraper" styleClass="wraper">
				<h:panelGroup layout="block" id="mainContent"
					...
					<br><h2><h:outputText value="#{bundle.foto}"></h:outputText></h2><br><br>
					
					<h:graphicImage value="#{casoClinicoBean.fotoVisualizada}"></h:graphicImage>
					
					<br><br>
					<a href="upload.jsp">
					<h:outputText value="#{bundle.uploadNovamente}"></h:outputText></a>
					<br><br>
					<a href="addCasoClinico.jsp">
					<h:outputText value="#{bundle.voltarCadastro}"></h:outputText></a>
				</h:panelGroup>
