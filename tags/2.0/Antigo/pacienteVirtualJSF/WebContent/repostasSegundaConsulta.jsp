...
<h:panelGroup layout="block" id="tudo" styleClass="tudo">
	<h:panelGroup layout="block" id="conteudo" styleClass="conteudo">
		...
		<h:panelGroup layout="block" id="sidebar" styleClass="sidebar">
			<h:graphicImage value="#{respostaDoAluno3Bean.alunoLogado.consultaAtual.fkCasoClinico.fotoFileName}"></h:graphicImage>
			<br>
			<h:outputText value="#{bundle.casoInicial} " style="font-weight: bold;" ></h:outputText>	
			<h:outputText value="#{respostaDoAluno3Bean.alunoLogado.consultaAtual.fkCasoClinico.relatoDeCasoPrimeiraConsulta}"/>
			<br><br>
			<h:outputText value="#{bundle.casoEvolucao} " style="font-weight: bold;" ></h:outputText>	
			<h:outputText value="#{respostaDoAluno3Bean.alunoLogado.consultaAtual.fkCasoClinico.relatoDeCasoSegundaConsulta}"/>
		</h:panelGroup>
		...
		<br>
		<h:outputText value="#{respostaDoAluno3Bean.respostaSegunda.comentarioAluno}"></h:outputText>
		<br>
		...
		<h:dataTable value="#{respostaDoAluno3Bean.listaGabarito}" var="currentQueixaResposta" >
			<h:column>
			<h:panelGrid columns="1">
		...
		<h:dataTable value="#{respostaDoAluno3Bean.listaAluno}" var="currentQueixaResposta" >
			<h:column>
			<h:panelGrid columns="1">
		...
		<h:panelGroup id="intervencoes" layout="block" styleClass="field">				
			<h:outputText value="#{bundle.resposta}" style="font-weight: bold"></h:outputText>			
			<h:dataTable border="1" value="#{respostaDoAluno3Bean.listaIntervencaoGabarito}" var="currentParametro"
				styleClass="dataTables" headerClass="headerDataTable" rowClasses="odd, even">
			...
			<br>
			<h:outputText value="#{bundle.respostaAluno}" style="font-weight: bold"></h:outputText>
			<h:dataTable border="1" value="#{respostaDoAluno3Bean.listaIntervencaoAluno}" var="currentParametro"
				styleClass="dataTables" headerClass="headerDataTable" rowClasses="odd, even">
