...
INSERT INTO `tb_turma_pessoa` VALUES (1,1,0);
...
-- Dump completed on 2013-08-20 21:16:33
CREATE DATABASE  IF NOT EXISTS `sace` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `sace`;
-- MySQL dump 10.13  Distrib 5.5.16, for Win32 (x86)
--
-- Host: localhost    Database: sace
-- ------------------------------------------------------
-- Server version	5.5.21
...
-- Dump completed on 2013-08-20 21:16:34
