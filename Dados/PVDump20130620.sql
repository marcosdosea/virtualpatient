...
CREATE TABLE `tb_consulta_parametro` (
  ...
  KEY `fk_tb_consulta_variavel_has_tb_parametro_clinico_tb_consulta_1` (`IdConsultaVariavel`),
  ...
  CONSTRAINT `fk_tb_consulta_variavel_has_tb_parametro_clinico_tb_consulta_1` FOREIGN KEY (`IdConsultaVariavel`) REFERENCES `tb_consulta_variavel` (`IdConsultaVariavel`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_instituicao` VALUES (1,'Universidade Federa de Sergipe','UFS');
...
INSERT INTO `tb_medicamentos` VALUES (1,'eee'),(2,'eeeeee');
...
INSERT INTO `tb_plano_saude` VALUES (1,'unimed brasil');
...
INSERT INTO `my_aspnet_sessioncleanup` VALUES ('2013-06-20 22:28:32',10,1);
...
CREATE TABLE `tb_relato_clinico` (
  ...
  `OrdemCronologia` int(11) NOT NULL,
  `RelatoTextual` text,
  `RelatoVideo` blob,
...
INSERT INTO `tb_ocupacao` VALUES (1,'enfermeiro 2');
...
CREATE TABLE `tb_turma_pessoa_relato` (
  ...
  PRIMARY KEY (`IdTurma`,`IdPessoa`,`IdRelato`),
...
CREATE TABLE `tb_consulta_variavel` (
  ...
  KEY `fk_tb_consulta_variavel_tb_turma_pessoa_relato1` (`IdTurma`,`IdPessoa`,`IdRelato`),
  KEY `fk_tb_consulta_variavel_tb_consulta_fixo1` (`IdConsultaFixo`),
  CONSTRAINT `fk_tb_consulta_variavel_tb_consulta_fixo1` FOREIGN KEY (`IdConsultaFixo`) REFERENCES `tb_consulta_fixo` (`IdConsultaFixo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_tb_consulta_variavel_tb_turma_pessoa_relato1` FOREIGN KEY (`IdTurma`, `IdPessoa`, `IdRelato`) REFERENCES `tb_turma_pessoa_relato` (`IdTurma`, `IdPessoa`, `IdRelato`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `my_aspnet_applications` VALUES (1,'/','MysqlSessioState');
...
INSERT INTO `my_aspnet_roles` VALUES (1,1,'aluno'),(3,1,'tutor'),(4,1,'administrador');
...
INSERT INTO `my_aspnet_sessions` VALUES ('1f3y2ld22bjhnfcwgwtnu1za',1,'2013-06-20 22:22:55','2013-06-20 22:43:09','2013-06-20 22:23:09',5,20,0,NULL,0),('3vq1ihe2dy3pdbrboul3admz',1,'2013-06-20 22:15:38','2013-06-20 22:35:38','2013-06-20 22:15:38',1,20,0,NULL,0),('4l5qvxq5wdf1mpckddbqxdvl',1,'2013-06-20 22:28:44','2013-06-20 22:48:46','2013-06-20 22:28:44',1,20,0,NULL,0),('5iiokhryfyhgvrvst5snk5ol',1,'2013-06-20 22:23:13','2013-06-20 22:43:14','2013-06-20 22:23:14',1,20,0,NULL,0),('b4tvldkbwt1ae0sdzxdpq23g',1,'2013-06-20 22:18:39','2013-06-20 22:38:39','2013-06-20 22:18:39',1,20,0,NULL,0),('c242nqqwna4gmn52rx1mqbsb',1,'2013-06-20 22:15:23','2013-06-20 22:35:25','2013-06-20 22:15:23',1,20,0,NULL,0),('dphn3rtxfodzbcb5tu5rctc2',1,'2013-06-20 22:23:11','2013-06-20 22:43:11','2013-06-20 22:23:11',1,20,0,NULL,0),('dwsdhgfcul34hx12kg1pjgpv',1,'2013-06-20 22:17:39','2013-06-20 22:37:40','2013-06-20 22:17:39',1,20,0,NULL,0),('elffsjf5a51u3q2ehkk1l4u4',1,'2013-06-20 22:28:32','2013-06-20 22:48:32','2013-06-20 22:28:32',1,20,0,NULL,0),('fn4euv50abhdscxdd4vja0ox',1,'2013-06-20 22:16:19','2013-06-20 22:36:22','2013-06-20 22:16:22',3,20,0,NULL,0),('gaun5admpxumfee5dv2jijfz',1,'2013-06-20 22:16:42','2013-06-20 22:36:48','2013-06-20 22:16:42',1,20,0,NULL,0),('idb1gxq1k2x0m1fcxanyrwg4',1,'2013-06-20 22:16:02','2013-06-20 22:36:02','2013-06-20 22:16:02',1,20,0,NULL,0),('jb2u0vgyx5qgfy2gxhywv0dq',1,'2013-06-20 22:23:15','2013-06-20 22:43:15','2013-06-20 22:23:15',1,20,0,NULL,0),('linanb4cyvkwc0jnbrym3014',1,'2013-06-20 22:18:39','2013-06-20 22:38:39','2013-06-20 22:18:39',1,20,0,NULL,0),('mqavkdy10pc0bbcglshki1dm',1,'2013-06-20 22:15:01','2013-06-20 22:35:08','2013-06-20 22:15:05',2,20,0,NULL,0),('ok0zbccrmjftkzq4lhxtmnev',1,'2013-06-20 22:22:58','2013-06-20 22:42:58','2013-06-20 22:22:58',1,20,0,NULL,0),('uupej3ejpinlk0wcg1csh4mg',1,'2013-06-20 22:18:53','2013-06-20 22:38:54','2013-06-20 22:18:54',1,20,0,NULL,0),('v2mpmxdyve2rpncs0dzg0okz',1,'2013-06-20 22:17:11','2013-06-20 22:37:11','2013-06-20 22:17:11',1,20,0,NULL,0),('vldneum0wy514sici3ifdi2n',1,'2013-06-20 22:23:12','2013-06-20 22:43:12','2013-06-20 22:23:12',1,20,0,NULL,0),('wul5vy32lbsb1we2qbl3q14z',1,'2013-06-20 22:28:32','2013-06-20 22:48:41','2013-06-20 22:28:39',3,20,0,NULL,0);
...
-- Dump completed on 2013-06-20 22:31:54
